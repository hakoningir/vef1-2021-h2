...
oklaradverk.addEventListener('click',async ()=>console.log(await getList('unfinished'), oklaradverk));
klaradverk.addEventListener('click',async ()=>console.log(await getList('finished'), klaradverk));
...
const veftag = document.querySelector('.vefthjonusta');
veftag.addEventListener('click',async ()=>console.log(await getList('vefthjonusta'), veftag));
